...
class trainer:
    def __init__(self):
        ...
        self.cnn_input_channels = 8
                  # e.g., grayscale image
        self.cnn_output_channels = 64        # starting CNN output channels
        self.lstm_input_size = 128            # flattened CNN output channels
        self.lstm_hidden_size = 256          # LSTM hidden size
        self.transformer_input_size = 32     # transformer input size (d_model)
        self.transformer_num_heads = 8       # transformer number of heads
        self.transformer_hidden_dim = 512     # transformer hidden dimension (feedforward layer)
